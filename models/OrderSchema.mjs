    ...
    paymentInfo: {
      method: {
        ...
        enum: {
          ...
          message: "Payment method must be one of: stripe, paypal, cash-on-delivery"
        },
        required: true
      },
      ...
      status: {
        ...
        enum: {
          ...
          message: "Payment status must be one of: pending, paid, failed, refunded, partially-refunded"
        },
        default: 'pending'
      }
    },
